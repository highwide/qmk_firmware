...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT( \
    LCTL(KC_GRV),KC_F1,  KC_F2,     KC_F3,     KC_F4,     KC_F5,          KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,    KC_F11,   KC_F12,    XXXXXXX,  \
    LCTL(KC_TAB),XXXXXXX, LCTL(KC_W),LCTL(KC_E),LCTL(KC_R),LCTL(KC_T),     XXXXXXX,   LCTL(KC_U),KC_TAB,    XXXXXXX,   KC_UP,     KC_ESC,   XXXXXXX,   XXXXXXX, \
    XXXXXXX,    LCTL(KC_A),LCTL(KC_S),LCTL(KC_D),KC_RGHT,   XXXXXXX,        KC_BSPC,   XXXXXXX,   LCTL(KC_K),LCTL(KC_L),XXXXXXX,   XXXXXXX,  XXXXXXX,           \
    _______,     XXXXXXX,   XXXXXXX,   LCTL(KC_C),XXXXXXX,   KC_LEFT,        KC_DOWN,   KC_ENT,    XXXXXXX,   XXXXXXX,   XXXXXXX,  _______,  KC_PGUP,  _______, \
    XXXXXXX, _______,       _______,    _______,             XXXXXXX,        XXXXXXX,               XXXXXXX,   XXXXXXX,        LCTL(KC_LEFT),KC_PGDN,LCTL(KC_RIGHT) \
  ),
  [2] = LAYOUT( \
